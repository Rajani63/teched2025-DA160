...
1. Open this link in a **new tab** to access the <b>[SAP BDC Cockpit](https://trial-bdc-core.eu10.hcs.cloud.sap/)</b>, use the username `AC248214Uxx` with the number `xx` provided to you on the workshop. Use this password: **ObKa8VVKWK1!**
